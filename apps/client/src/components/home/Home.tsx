...
// Define types for the chat message and partner information
...
// Define types for the events emitted by the server
...
// Create a single socket instance outside of the component with proper types
...
const RandomChat: React.FC = () => {
  ...
  useEffect(() => {
    ...
    socket.on('partnerDisconnected', () => {
      ...
      setPartner(null);
      setChat([]);
      findRandomChatPartner();  // Automatically find a new chat partner
    });
          ...
          <div className="flex-grow overflow-y-auto mb-4">
            {chat.map((msg, index) => (
              ...
              >
                <div
                  className={`${
                    msg.from === 'You' ? 'bg-green-500 text-white' : 'bg-gray-200 text-black'
